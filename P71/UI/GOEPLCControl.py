...
'''
Release Note:
update IsPython3 to support Python3 2019/10/11
'''
...
# ********************************************************************************#
    ...
    def ChooseCOM(self,serialName):
        try:
            ...
            self.strErrorMessage =  "ChooseCOM fail " + str(e)
...
# ********************************************************************************#
    ...
    def MoveToCoordinates(self,ofWhatAxis,Value,timeout=20):
        if(self.ser.isOpen() == False):
            self.strErrorMessage =  "The serial port is not opened"
            return -1
        # Move X-Axis
...
# ********************************************************************************#
    ...
    def GetSpeed(self,ofWhatAxis):
        ...
        try:
            ...
            self.strErrorMessage = "GetSpeed error " + e
            return  -1
# ********************************************************************************#
...
# ********************************************************************************************#
    ...
    def GetLimit(self,ofWhatAxis,ofWhatLimit):
        ...
        try:
            ...
            self.strErrorMessage = "GetLimit error " + e
            return -9999
#********************************************************************************************#
...
# ********************************************************************************************#
    ...
    # ********************************************************************************************#
    def SignalReset(self,timeout=20):
        try:
            mytimeCount = 0
...
# ********************************************************************************************#
 ...
 # ********************************************************************************************#
    def CalibrationPosition(self,PositionList):
        try:
            ### Declare Variables #####
            Xval_1 = 0.0
            Xval_2 = 0.0
            ...
            zAxisCalX = float(PositionList[0])
            zAxisCalY = float(PositionList[1])
            XAxisCalIncrementX = float(PositionList[2])
            XAxisCalIncrementY = float(PositionList[3])
            XAxisCalDecrementX = float(PositionList[4])
            XAxisCalDecrementY = float(PositionList[5])
            YAxisCalIncrementX = float(PositionList[6])
            YAxisCalIncrementY = float(PositionList[7])
            YAxisCalDecrementX = float(PositionList[8])
            YAxisCalDecrementY = float(PositionList[9])
...
# ********************************************************************************#
 ...
 # ********************************************************************************************#
    def CalibratePositionOfV71(self, point,PositionList):
        try:
             ### Declare Variables #####
            ...
            YAxisCalDecrementX = float(PositionList[8])
            YAxisCalDecrementY = float(PositionList[9])
            originalPoints = [[YAxisCalIncrementX,YAxisCalIncrementY],[YAxisCalDecrementX,YAxisCalDecrementY],[XAxisCalIncrementX,XAxisCalIncrementY],[XAxisCalDecrementX,XAxisCalDecrementY]]
